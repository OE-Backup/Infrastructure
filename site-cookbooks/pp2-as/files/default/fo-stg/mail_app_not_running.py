...
Subject: [STG] Account Service app: http://tolkien:thejohn@stg-account-service-i.thinkglish.com:8080/account_service/static/restapi.html not reachable, please check it . 

Account Service not reachable after promotion to SLAVE (10.16.1.12).
"""
