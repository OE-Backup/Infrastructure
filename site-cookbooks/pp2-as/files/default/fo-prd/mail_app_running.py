...
Subject: [PRD] Account Service app is UP in slave (10.0.111.12) . 

Account Service is UP after promotion to SLAVE (10.0.111.12).
Check it out going to: http://tolkien:thejohn@prd-account-service-i.oe-sys.com:8080/account_service/static/restapi.html
"""
